...
That runs `.github/workflows/release.yml`, which tests, publishes a self-contained win-x64 build, fetches tools, and creates a GitHub Release with `fetch-it-v1.1.13-win-x64-setup.exe` and `fetch-it-v1.1.13-win-x64.zip`.
